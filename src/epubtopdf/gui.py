...
class EpubToPdfGUI:
    ...
    def create_widgets(self):
        ...
        self.progress_bar.grid(row=4, column=1, columnspan=2, sticky=(W, E), padx=(10, 0), pady=5)
        ...
        self.status_label.grid(row=5, column=0, columnspan=3, sticky=(W, E), pady=(10, 0))
        
        # Log text area
        ttk.Label(main_frame, text="Log:").grid(row=6, column=0, sticky=NW, pady=(10, 5))
        ...
        self.log_text.grid(row=6, column=1, columnspan=2, padx=(10, 0), pady=(10, 0), sticky=(W, E, N, S))
